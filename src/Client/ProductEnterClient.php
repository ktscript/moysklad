...
use MoySklad\Entity\Document\ProductEnter;

/**
 * Клиент оприходований товара
 */
class ProductEnterClient extends EntityClientBase
{
    use
    ...
    {
        parent::__construct($api, '/entity/enter/');
    }
